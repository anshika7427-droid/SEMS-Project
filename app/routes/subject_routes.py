...
async def create_subject(
    ...
    try:
        new_subject = await SubjectService.create_subject(db, subject, current_user.id)
...
async def get_subject_by_id(
    ...
    try:
        subject = await SubjectService.get_subject(db, subject_id, current_user.id)
...
async def update_subject(
    ...
    try:
        updated_subject = await SubjectService.update_subject(db, subject_id, subject_data, current_user.id)
...
async def delete_subject(
    ...
    try:
        await SubjectService.delete_subject(db, subject_id, current_user.id)
